  ...
  if (param_count != 1) /* validate parameter count */
{
  ...
  char res_dest_data[STRING_SIZE];
  int res_int_data;
  bool res_is_null[3];
  bool error[3];
  ...
  res_bind[1].buffer = (char *)&res_sender_data;
  ...
  res_bind[2].buffer = (char *)&res_dest_data;
  res_bind[2].is_null = &res_is_null[2];
  res_bind[2].length = &length[2];
  res_bind[2].error = &error[2];
